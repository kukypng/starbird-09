      ...
      case 'company':
        return <div className="space-y-4">
            <div>
              ...
              <Input id="company_name" type="text" inputMode="text" value={formData.company_name} onChange={e => setFormData(prev => ({
              ...prev,
            ...
            <div>
              ...
              <Input id="company_phone" type="tel" inputMode="tel" value={formData.company_phone} onChange={e => setFormData(prev => ({
              ...prev,
              company_phone: e.target.value
            }))} className="mt-1" placeholder="(11) 3333-4444" />
            </div>
          </div>;
      case 'app':
        return <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch checked={formData.dashboard_lite_enabled} onCheckedChange={checked => setFormData(prev => ({
              ...prev,
              dashboard_lite_enabled: checked
            }))} />
            </div>
            
            {/* Admin Dashboard Toggle */}
            {profile?.role === 'admin' && <div className="flex items-center justify-between">
                <div>
                ...
                <Switch checked={formData.force_normal_dashboard} onCheckedChange={checked => setFormData(prev => ({
              ...prev,
              force_normal_dashboard: checked
            }))} />
              </div>}
            ...
            <div className="p-3 bg-muted/50 rounded-lg">
              <p className="text-sm text-muted-foreground">
                ...
                {profile?.role === 'admin' && <> Administradores podem forçar o uso do dashboard normal mesmo em dispositivos móveis.</>}
              </p>
            </div>
          </div>;
      default:
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="p-4 border-b">
          <div className="flex gap-2 overflow-x-auto">
            ...
            return <Button key={section.id} variant={activeSection === section.id ? "default" : "outline"} size="sm" onClick={() => setActiveSection(section.id)} className="flex items-center gap-2 whitespace-nowrap">
        ...
        <div className="p-4">
          ...
          <div className="mt-4">
            <Button onClick={handleSave} disabled={loading} className="w-full" size="lg">
              {loading ? <div className="w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin mr-2" /> : <Save className="mr-2 h-4 w-4" />}
              Salvar Alterações
            </Button>
          </div>
        </div>
