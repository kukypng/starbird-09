...
export const AdminLite = ({ userId, onBack }: AdminLiteProps) => {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        const active = usersData.filter((user: any) => 
          user.license_expires_at && new Date(user.license_expires_at) > new Date()
        ).length;
            ...
            {loading ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Nenhum usuário encontrado ou sem permissão de admin
                </p>
              </div>
            ) : (
              users.map((user) => (
            ...
            {users.length > 0 && (
              <div className="text-center pt-2">
                <p className="text-xs text-muted-foreground">
                  Mostrando primeiros 10 usuários. Versão completa em breve.
                </p>
              </div>
            )}
          </CardContent>
